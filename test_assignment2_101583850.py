...
from assignment2_101583850 import PortScanner, commonPorts
...
class TestPortScanner(unittest.TestCase):
    ...
    def test_common_ports_dict(self):
        ...
        self.assertEqual(commonPorts[80], "HTTP")
        # Assert common_ports[22] equals "SSH"
        self.assertEqual(commonPorts[22], "SSH")
